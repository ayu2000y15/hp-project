...
class CreateImagesTable extends Migration
{
    public function up()
    {
        Schema::create('images', function (Blueprint $table) {
            $table->string('file_name', 200)->primary()->comment('ファイル名');
            ...
            $table->foreign('talent_id')->references('data_id')->on('hp_data')->onDelete('cascade');
            $table->foreign('view_flg')->references('view_flg')->on('view_flags')->onDelete('cascade');
